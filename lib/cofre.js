...
// Copia de tudo (pacote de exportacao) e troca completa de uma plataforma (importacao).
function todas() { return JSON.parse(JSON.stringify(carregar())); }
function substituir(plataforma, campos) {
  carregar()[plataforma] = { ...campos };
  persistir();
}
...
module.exports = { obter, atualizar, remover, todas, substituir, segredos, lerStatus, gravarStatus, carregar, DADOS, gravarAtomico };
