...
// depois de receber a biblioteca de outro painel
function recarregar() { lista = null; }

module.exports = { recarregar, listar, obter, receberUpload, importarCaminho, listarPasta, importarLink, importarTrecho, importarSequencia, preparar, renomear, remover, limparTemporarios };
