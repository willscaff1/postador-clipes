...
const FONTE = ['C:/Windows/Fonts/ariblk.ttf', 'C:/Windows/Fonts/arialbd.ttf'].find((f) => fs.existsSync(f)) || 'C:/Windows/Fonts/arial.ttf';
const fonteFiltro = FONTE.replace(/:/g, '\\:');
...
const FONTE_SIMBOLO = fs.existsSync('C:/Windows/Fonts/seguisym.ttf') ? 'C\\:/Windows/Fonts/seguisym.ttf' : null;
const FONTE_TAG = (fs.existsSync('C:/Windows/Fonts/seguibl.ttf') ? 'C:/Windows/Fonts/seguibl.ttf' : FONTE).replace(/:/g, '\\:');
