...
const ESCOPOS = ['clips:edit', 'user:read:email'];

module.exports = {
  id: 'twitch', nome: 'Twitch', tipo: 'fonte', oauth: true,
  opcional: true,
  redirect: (porta) => `http://localhost:${porta}/oauth/twitch/callback`,
  campos: [
  ...
  listarClipes, linkDoClipe, slugDoLink, limparCanal, listarLives, aoVivo, hlsDaLive, clipar, metricas,
};
